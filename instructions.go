...
var InstructionImplDef = ag_binary.NewVariantDefinition(
	...
	[]ag_binary.VariantType{
		{
			Name: "collect_fund_fee", Type: (*CollectFundFeeInstruction)(nil),
		},
		{
			Name: "collect_protocol_fee", Type: (*CollectProtocolFeeInstruction)(nil),
		},
		{
			Name: "create_amm_config", Type: (*CreateAmmConfigInstruction)(nil),
		},
		{
		...
		{
			Name: "swap_base_input", Type: (*SwapBaseInputInstruction)(nil),
		},
		{
			Name: "swap_base_output", Type: (*SwapBaseOutputInstruction)(nil),
		},
		{
			Name: "update_amm_config", Type: (*UpdateAmmConfigInstruction)(nil),
		},
		{
			Name: "update_pool_status", Type: (*UpdatePoolStatusInstruction)(nil),
		},
		{
